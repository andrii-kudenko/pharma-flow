        ...
        <div className="flex h-screen">
            ...
            <div
                className={`fixed inset-y-0 left-0 bg-gray-800 text-white transform ${
                    isSidebarOpen
                        ? "translate-x-0 md:w-58"
                        : "-translate-x-full md:w-16"
                } md:relative md:translate-x-0 transition-width transition-transform duration-300 ease-in-out z-50`}
            >
                        ...
                        <li className="hover:bg-gray-700 transition-opacity duration-300 ease-in-out">
                            ...
                            {isSublistOpen && (
                                <ul className="pl-4">
                                    <li className="hover:bg-gray-700 transition-opacity duration-300 ease-in-out">
                                        <NavLink
                                            to="/inspect-sales-trends"
                                            className="block w-full h-full p-4"
                                            activeClassName="bg-gray-900"
                                        >
                                            Inspect Sales Trends
                                        </NavLink>
                                    </li>
                                    <li className="hover:bg-gray-700 transition-opacity duration-300 ease-in-out">
                                        <NavLink
                                            to="/inspect-total-revenue"
                                            className="block w-full h-full p-4"
                                            activeClassName="bg-gray-900"
                                        >
                                    ...
                                    <li className="hover:bg-gray-700 transition-opacity duration-300 ease-in-out">
                                        <NavLink
                                            to="/evaluate-high-value-customers"
                                            className="block w-full h-full p-4"
                                            activeClassName="bg-gray-900"
                                        >
                                            Evaluate High Value Customers
                                        </NavLink>
                                    </li>
                                    <li className="hover:bg-gray-700 transition-opacity duration-300 ease-in-out">
                                        <NavLink
            ...
            <div className="flex-1 overflow-auto">
                <div className="flex items-center justify-center md:justify-between bg-gray-800 p-2 h-20">
                    <button
                        id="nav-toggle-btn"
                        onClick={toggleSidebar}
                        className="text-xl md:hidden absolute left-2"
                    >
                        <FaBars />
                    </button>
                    ...
                    <img
                        src={pf_logo}
                        alt="logo"
                        className="h-10 absolute right-2 md:relative"
                    ></img>
                </div>
